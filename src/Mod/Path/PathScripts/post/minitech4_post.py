# ***************************************************************************
# *   (c) jhwnkim (jhwnkim@mit.edu) 2020                                    *
# *   based on linuxcnc by sliptonic (shopinthewoods@gmail.com) 2014        *
# *                                                                         *
...
UNIT_SPEED_FORMAT = 'in/min' # mm/min for metric
UNIT_FORMAT = 'in' # mm for metric

MACHINE_NAME = "mach3mill"
CORNER_MIN = {'x': 0, 'y': 0, 'z': 0}
CORNER_MAX = {'x': 12, 'y': 9, 'z': 9}
PRECISION = 4 # 3 for metric


# Preamble text will appear at the beginning of the GCODE output file.
PREAMBLE = '''G90 G94 G91.1 G40 G49 G17
'''
